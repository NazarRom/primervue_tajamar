<template>
  <div>
    ...
    <h3 v-if="numero < 0 " style="color:red">NEGATIVO</h3>
    <h3 v-else style="color:salmon">CERO</h3>
    ...
    <h1>
        <!--Podemos dibujar todo el contenido de data() utilizando el DOLAR $-->
        {{$data}}
    </h1>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      nombre: "",
      edad: 0,
      series:["Futurama","Suits","The walking dead","Como conoci a vuestra madre","House"]
    };
  },
};
</script>
